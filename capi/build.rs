...
fn main() {
    ...
    let config_enum_c = EnumConfig { rename_variants: Some(RenameRule::ScreamingSnakeCase), prefix_with_name: true, .. EnumConfig::default() };

    let config_c = Config { language: Language::C, enumeration: config_enum_c, .. Config::default() };
